...
namespace AwesomeToon
{
    ...
    public class AwesomeToonHelper : MonoBehaviour
    {
        ...
        LightSet CalcLight(LightSet lightSet)
        {
            ...
            switch (light.type)
            {
                ...
                case LightType.Point:
                    ...
                    lightSet.color = light.color * lightSet.atten * light.intensity * 1f;
                    break;
        ...
        {
            return Mathf.Clamp01(1.0f / (1.0f + 25f * dist * dist) * Mathf.Clamp01((1f - dist) * 5f) * 5f);
        }
